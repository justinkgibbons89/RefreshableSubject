...
/** 
	...
	reference to it. `RefreshableSubject` should be customized by implementing a `Refreshable`–conforming service above it, a custom subsciber beneath
	it, or both.
*/
@available(macOS 10.15, *)
public class RSSubscription<Output>: Subscription {
